...
export const Route = createFileRoute("/articles/")({
  ...
  head: () => ({
    meta: [
      { title: "কুরআনের প্রবন্ধ ও গবেষণা — কুরআন অন্বেষা | Quran Explorer" },
      {
        name: "description",
        content: "পবিত্র কুরআন সম্পর্কিত তথ্যবহুল প্রবন্ধ, গবেষণা ও আধুনিক তাদাব্বুর।",
      },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://wooniche.com/articles" },
      { property: "og:site_name", content: "কুরআন অন্বেষা — Quran Explorer" },
      { property: "og:title", content: "কুরআনের প্রবন্ধ ও গবেষণা — কুরআন অন্বেষা | Quran Explorer" },
      {
      ...
      { name: "twitter:title", content: "কুরআনের প্রবন্ধ ও গবেষণা — কুরআন অন্বেষা | Quran Explorer" },
      { name: "twitter:description", content: "পবিত্র কুরআনের গভীর আলোচনা ও বিষয়ভিত্তিক বিশ্লেষণ।" },
      { name: "twitter:image", content: "https://wooniche.com/og-image.jpg" },
    ],
    links: [
      { rel: "canonical", href: "https://wooniche.com/articles" },
    ],
  }),
