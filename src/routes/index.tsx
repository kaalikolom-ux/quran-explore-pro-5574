      ...
      <section className="mx-auto w-full max-w-6xl px-4 py-10 sm:py-14">
        <div className="min-w-0">
          ...
          <div className="relative mt-6 w-full">
            {/* চার কোণায় উড়ে যাওয়া লাল তারাবাত্তি */}
            <span
              aria-hidden="true"
            ...
            <div className="relative z-0 rounded-2xl border border-red-500/45 bg-red-950/25 p-4 sm:p-5 text-center backdrop-blur-md shadow-[0_0_22px_rgba(239,68,68,0.25)] animate-sparkle-burst transition-all duration-300">
              <div className="flex items-center justify-center gap-2 mb-2 text-red-400 dark:text-red-300 font-semibold text-xs sm:text-sm">
