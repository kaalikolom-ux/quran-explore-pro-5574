...
function SettingsPage() {
  ...
  const displayLayers: { key: keyof Prefs; title: string; desc: string }[] = [
    ...
    },
    {
      ...
      title: lang === "bn" ? "৫. আক্ষরিক অনুবাদ" : "5. Literal Translation",
      desc: lang === "bn" ? "মুহিউদ্দীন খান / তাইসিরুল কুরআন (Greentech)" : "Literal Bengali translation",
    },
    {
      key: "showConventionalEn",
      title: lang === "bn" ? "৬. Surface Translation" : "6. Surface Translation",
      desc: lang === "bn" ? "সহীহ ইন্টারন্যাশনাল স্ট্যান্ডার্ড অনুবাদ (Greentech)" : "Sahih International translation",
    },
    {
      key: "showCoreMeaningBn",
      title: lang === "bn" ? "৭. অন্তর্গত অনুবাদ" : "7. Interlinear Translation (Bangla)",
      desc: lang === "bn" ? "আয়াতের অন্তর্গত ভাবার্থ ও মূল বার্তা" : "Inherent contextual translation in Bangla",
    },
    {
      key: "showCoreMeaningEn",
      title: lang === "bn" ? "৮. Interlinear Translation" : "8. Interlinear Translation",
      desc: lang === "bn" ? "আয়াতের ইন্টারলিনিয়ার ইংরেজি ভাবার্থ ও মূল বার্তা" : "Interlinear contextual translation in English",
    },
    {
      key: "showModernBn",
      title: lang === "bn" ? "৯. বৈজ্ঞানিক অনুবাদ" : "9. Scientific Translation (Bangla)",
      desc: lang === "bn" ? "আমাদের আধুনিক ও সমসাময়িক বিজ্ঞানভিত্তিক বাংলা অনুবাদ" : "Contemporary scientific Bengali translation",
    },
    {
      key: "showModernEn",
      title: lang === "bn" ? "১০. Scientific Translation" : "10. Scientific Translation",
      desc: lang === "bn" ? "আমাদের সমসাময়িক বিজ্ঞানভিত্তিক ইংরেজি অনুবাদ" : "Contemporary scientific English translation",
    },
    {
      key: "showLexicon",
