...
export const QURAN_THEMATIC_DATABASE: ThematicTopic[] = [
  // ১. বিজ্ঞান ও সৃষ্টিতত্ত্ব (Science, Astronomy & Biology)
  {
    ...
    description_bn:
      "মহাবিশ্ব যে প্রতিনিয়ত সম্প্রসারিত হচ্ছে সে সম্পর্কে কুরআনের বৈজ্ঞানিক নিদর্শন।",
    ...
    references: [
      {
        ...
        ayah_range: "৫১:৪৭",
        highlight_text_bn:
          "আমি নিজ শক্তিবলে আকাশ সৃষ্টি করেছি এবং নিশ্চয়ই আমিই একে প্রতিনিয়ত সম্প্রসারিত করছি।",
      },
    ],
  },
  {
    ...
    category_en: "Science & Cosmology",
    description_bn:
      "আসমান ও জমিনের একত্রিত অবস্থা থেকে বিস্ফোরণ এবং পানি থেকে সমস্ত প্রাণের সৃষ্টি।",
    description_en:
      "The heavens and the earth joined together, split apart, and life created from water.",
    icon: "Sparkles",
    keywords: [
      "বিগ ব্যাং",
      "সৃষ্টিতত্ত্ব",
    ...
    references: [
      {
        ...
        ayah_range: "২১:৩০",
        highlight_text_bn:
          "কাফেররা কি দেখে না যে আসমান ও জমিন ওতপ্রোতভাবে মিশে ছিল, অতঃপর আমি উভয়কে পৃথক করে দিলাম এবং প্রাণবান সবকিছু পানি থেকে সৃষ্টি করলাম?",
      },
    ],
  },
  {
    ...
    references: [
      {
        ...
        ayah_range: "২৩:১২-১৪",
        highlight_text_bn:
          "আমি মানুষকে মাটির নির্যাস থেকে সৃষ্টি করেছি, অতঃপর শুক্রবিন্দু, জমাট রক্ত, মাংসপিণ্ড এবং হাড়ে রূপান্তর করে মাংস দ্বারা ঢেকে দিয়েছি।",
      },
      {
        surah: 96,
        ...
        ayah_range: "৯৬:১-২",
        highlight_text_bn:
          "পাঠ করুন আপনার পালনকর্তার নামে যিনি সৃষ্টি করেছেন জমাট রক্তপিণ্ড (আলাক) থেকে।",
      },
    ],
  },
  {
    ...
    references: [
      ...
      },
      {
        ...
        ayah_range: "২১:৩১",
        highlight_text_bn:
          "আমি পৃথিবীতে ভারী পর্বতমালা স্থাপন করেছি যাতে তা মানুষকে নিয়ে হেলে না পড়ে।",
      },
    ],
  },
  {
    ...
    description_en:
      "The invisible barrier between meeting seas preventing them from transgressing.",
    icon: "Waves",
    keywords: [
      "সমুদ্র",
      "সাগর",
    ...
    references: [
      {
        ...
        ayah_range: "৫৫:১৯-২০",
        highlight_text_bn:
          "তিনি পাশাপাশি দুই সাগর প্রবাহিত করেছেন, উভয়ের মাঝে রয়েছে এক অন্তরাল যা তারা অতিক্রম করে না।",
      },
      {
        surah: 25,
        ...
        ayah_range: "২৫:৫৩",
        highlight_text_bn:
          "তিনিই দুই দরিয়াকে একসাথে মিলিত করেছেন—একটি সুমিষ্ট তৃষ্ণানিবারক, অন্যটি নোনা বিস্বাদ; এবং মাঝে রেখেছেন এক পর্দা।",
      },
    ],
  },
  {
    ...
    description_bn:
      "লোহা পৃথিবীতে তৈরি হয়নি বরং মহাকাশ থেকে সুপারনোভার মাধ্যমে নাযিল বা প্রেরিত হয়েছে।",
    ...
    references: [
      {
        ...
        ayah_range: "৫৭:২৫",
        highlight_text_bn:
          "এবং আমি লোহা অবতীর্ণ করেছি যাতে রয়েছে প্রচণ্ড শক্তি এবং মানুষের বহুবিধ কল্যাণ।",
      },
    ],
  },
  {
    ...
    references: [
      {
        ...
        ayah_range: "২১:৩৩",
        highlight_text_bn:
          "তিনিই সৃষ্টি করেছেন রাত ও দিন এবং সূর্য ও চাঁদ; প্রত্যেকেই নিজ নিজ কক্ষপথে বিচরণ করছে।",
      },
      {
        surah: 36,
        ...
        ayah_range: "৩৬:৩৮-৪০",
        highlight_text_bn:
          "সূর্য তার নির্দিষ্ট গন্তব্যের দিকে ছুটে চলে... আর চন্দ্রের জন্য আমি নির্ধারণ করেছি বিভিন্ন মনযিল।",
      },
    ],
  },
  ...
  // ২. পরিবার, সমাজ ও নৈতিকতা (Family, Social Ethics & Manners)
  {
    ...
    description_bn:
      "পিতা-মাতার সাথে সর্বোত্তম ব্যবহার, বার্ধক্যে সেবা এবং তাদের জন্য দুআ করার নির্দেশ।",
    description_en:
      "Commandments on treating parents with utmost kindness, respect and prayers in old age.",
    icon: "Heart",
    keywords: [
      "পিতা মাতা",
      "মা বাবা",
    ...
    references: [
      {
        ...
        ayah_range: "১৭:২৩-২৪",
        highlight_text_bn:
          "তোমার প্রতিপালক আদেশ দিয়েছেন... পিতা-মাতার সাথে সদ্ব্যবহার কর। তাদের একজন বা উভয়ে বার্ধক্যে উপনীত হলে তাদের 'উফ' বলো না এবং তাদের জন্য রহমতের ডানা বিছিয়ে দাও।",
      },
      {
        surah: 31,
        ...
        ayah_range: "৩১:১৪",
        highlight_text_bn:
          "আমি মানুষকে তার পিতা-মাতার ব্যাপারে নির্দেশ দিয়েছি; তার মা কষ্টের পর কষ্ট সহ্য করে তাকে গর্ভে ধারণ করেছে।",
      },
      {
        surah: 46,
    ...
    references: [
      {
        ...
        ayah_range: "৩০:২১",
        highlight_text_bn:
          "তাঁর অন্যতম নিদর্শন এই যে, তিনি তোমাদের মধ্য থেকে তোমাদের সঙ্গিনী সৃষ্টি করেছেন যাতে তোমরা তাদের নিকট প্রশান্তি পাও এবং তোমাদের মাঝে ভালোবাসা ও দয়া সৃষ্টি করেছেন।",
      },
      {
        surah: 4,
    ...
    references: [
      {
        ...
        ayah_range: "৪:২, ১০",
        highlight_text_bn:
          "এতিমদের তাদের ধন-সম্পদ সমর্পণ কর... যারা অন্যায়ভাবে এতিমদের সম্পদ গ্রাস করে, তারা তাদের পেটে আগুনই ভর্তি করে।",
      },
      {
        surah: 93,
        ...
        ayah_range: "৯৩:৯-১০",
        highlight_text_bn:
          "অতএব আপনি এতিমের প্রতি কঠোর হবেন না এবং সাহায্যপ্রার্থীকে ধমক দেবেন না।",
      },
      {
        surah: 107,
        ...
        ayah_range: "১০৭:১-৩",
        highlight_text_bn:
          "আপনি কি দেখেছেন তাকে যে বিচার দিবসকে অস্বীকার করে? সে তো এতিমকে তাড়িয়ে দেয় এবং মিসকিনকে অন্নদানে উৎসাহিত করে না।",
      },
    ],
  },
  {
    ...
    description_en:
      "Backbiting compared to eating the flesh of a dead brother; prohibition of suspicion.",
    ...
    references: [
      {
        ...
        ayah_range: "৪৯:১২",
        highlight_text_bn:
          "হে মুমিনগণ! তোমরা অধিকাংশ অনুমান থেকে দূরে থাক... এবং একে অপরের গীবত করো না; তোমাদের কেউ কি তার মৃত ভাইয়ের গোশত খাওয়া পছন্দ করবে?",
      },
      {
        surah: 104,
        ...
        ayah_range: "১০৪:১",
        highlight_text_bn:
          "ধ্বংস প্রত্যেক এমন ব্যক্তির জন্য যে পশ্চাতে ও সম্মুখে মানুষের কুৎসা রটায় ও দোষ খুঁজে বেড়ায়।",
      },
    ],
  },
    ...
    references: [
      {
        ...
        highlight_text_bn:
          "আল্লাহ ব্যবসাকে হালাল করেছেন এবং সুদকে হারাম করেছেন... হে মুমিনগণ! সুদ পরিহার কর, যদি তা না কর তবে আল্লাহ ও তাঁর রাসূলের বিরুদ্ধে যুদ্ধের ঘোষণা জেনে নাও।",
      },
      {
        surah: 3,
  ...
  },
  {
    ...
    description_en:
      "The longest verse in the Quran detailing financial agreements, debts, and witnesses.",
    icon: "FileText",
    keywords: [
      "ঋণ",
      "চুক্তি",
    ...
    references: [
      {
        ...
        ayah_range: "২:২৮২",
        highlight_text_bn:
          "হে মুমিনগণ! যখন তোমরা নির্দিষ্ট মেয়াদের জন্য ঋণের লেনদেন কর, তখন তা লিখে রাখ...",
      },
    ],
  },
  {
    ...
    description_en:
      "The 8 recipients of Zakat and immense rewards of spending in the way of Allah.",
    icon: "HandCoins",
    keywords: [
      "যাকাত",
      "সদকা",
    ...
    references: [
      {
        ...
        highlight_text_bn:
          "যারা আল্লাহর পথে নিজেদের ধন-সম্পদ ব্যয় করে, তাদের দৃষ্টান্ত একটি বীজের মতো যা সাতটি শীষ উৎপন্ন করে, প্রতিটি শীষে একশত শস্যদানা থাকে।",
      },
      {
        surah: 9,
        ...
        ayah_range: "৯:৬০",
        highlight_text_bn:
          "যাকাত কেবল দরিদ্র, মিসকিন, যাকাত আদায়ে নিযুক্ত কর্মচারী এবং যাদের অন্তর জয় করা উদ্দেশ্য...",
      },
    ],
  },
  ...
  // ৪. মানসিক প্রশান্তি, ধৈর্য ও বিপদাপদ (Patience, Inner Peace & Trials)
  {
    ...
    description_en:
      "Steadfast patience in adversity, with the divine promise that with hardship comes ease.",
    icon: "ShieldAlert",
    keywords: [
      "ধৈর্য",
      "সবর",
    ...
    references: [
      {
        ...
        highlight_text_bn:
          "হে মুমিনগণ! ধৈর্য ও সালাতের মাধ্যমে সাহায্য চাও; নিশ্চয়ই আল্লাহ ধৈর্যশীলদের সাথে আছেন... যারা বিপদে পড়লে বলে: ইন্না লিল্লাহি ওয়া ইন্না ইলাইহি রাজিউন।",
      },
      {
        surah: 94,
        ...
        ayah_range: "৯৪:৫-৬",
        highlight_text_bn:
          "নিশ্চয়ই কষ্টের সাথে স্বস্তি রয়েছে; নিঃসন্দেহে কষ্টের সাথেই স্বস্তি রয়েছে।",
      },
    ],
  },
  {
    ...
    references: [
      {
        ...
        ayah_range: "১৩:২৮",
        highlight_text_bn:
          "যারা ঈমান এনেছে এবং যাদের অন্তর আল্লাহর স্মরণে প্রশান্ত হয়; জেনে রাখ, আল্লাহর স্মরণেই কেবল অন্তরসমূহ শান্তি পায়।",
      },
    ],
  },
  {
    ...
    references: [
      {
        ...
        ayah_range: "৩৯:৫৩",
        highlight_text_bn:
          "বলুন: হে আমার বান্দাগণ যারা নিজেদের ওপর অবিচার করেছ! তোমরা আল্লাহর রহমত থেকে নিরাশ হয়ো না; নিশ্চয়ই আল্লাহ সমস্ত পাপ ক্ষমা করে দেন।",
      },
      {
        surah: 12,
        surah_name_bn: "ইউসুফ",
        ...
        ayah_range: "১২:৮৭",
        highlight_text_bn:
          "আল্লাহর রহমত থেকে নিরাশ হয়ো না; কাফের সম্প্রদায় ছাড়া কেউ আল্লাহর রহমত থেকে নিরাশ হয় না।",
      },
    ],
  },
  ...
  // ৫. ইবাদত ও বিধিবিধান (Worship & Core Commandments)
  {
    ...
    description_en:
      "Performing prayer at prescribed times and how prayer prevents immorality and wrongdoing.",
    icon: "Clock",
    keywords: [
      "নামাজ",
      "সালাত",
    ...
    references: [
      {
        ...
        ayah_range: "২৯:৪৫",
        highlight_text_bn:
          "সালাত কায়েম করুন; নিশ্চয়ই সালাত অশ্লীল ও অন্যায় কাজ থেকে বিরত রাখে এবং আল্লাহর স্মরণই সর্বশ্রেষ্ঠ।",
      },
      {
        surah: 4,
        surah_name_bn: "আন-নিসা",
    ...
    references: [
      {
        ...
        highlight_text_bn:
          "হে ঈমানদারগণ! তোমাদের ওপর সিয়াম ফরজ করা হয়েছে যেমন ফরজ করা হয়েছিল তোমাদের পূর্ববর্তীদের ওপর, যাতে তোমরা তাকওয়া অর্জন করতে পার... রমজান মাস, যাতে কুরআন নাযিল করা হয়েছে।",
      },
    ],
  },
  ...
  // ৬. নবীদের ঘটনাবলী (Stories of the Prophets)
  {
    ...
    description_en:
      "Prophet Musa's mission, the miracle of the staff, parting of the sea and downfall of Pharaoh.",
    icon: "Scroll",
    keywords: [
      "মুসা",
      "মূসা",
    ...
    references: [
      {
        ...
        highlight_text_bn:
          "অতঃপর যখন সে তার পিতার সাথে চলাফেরার বয়সে পৌঁছাল, তখন ইবরাহীম বলল: হে বৎস! আমি স্বপ্নে দেখেছি যে তোমাকে জবেহ করছি... নিশ্চয়ই এটি ছিল এক স্পষ্ট পরীক্ষা।",
      },
      {
        surah: 2,
        surah_name_bn: "আল-বাকারাহ",
  ...
  },
  {
    ...
    description_en:
      "The Seal of the Prophets, supreme character, and sent as a mercy to all creation.",
    icon: "Sparkles",
    keywords: [
      "মুহাম্মদ",
      "মোহাম্মদ",
    ...
    references: [
      ...
      },
      {
        ...
        ayah_range: "৩৩:২১, ৪০",
        highlight_text_bn:
          "নিশ্চয়ই তোমাদের জন্য আল্লাহর রাসূলের মধ্যে রয়েছে সর্বোত্তম আদর্শ... মুহাম্মদ তোমাদের মধ্যে কোনো পুরুষের পিতা নন, বরং তিনি আল্লাহর রাসূল এবং শেষ নবী।",
      },
      {
        surah: 68,
