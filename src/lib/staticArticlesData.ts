...
export const STATIC_ARTICLES: StaticArticle[] = [{
  ...
  "content_bn": "\n<div class=\"article-rich-container space-y-10 text-foreground/90 font-sans\">\n\n  <!-- ইন্ট্রোডাকশন ব্যানার -->\n  <div class=\"rounded-3xl border-2 border-primary/20 bg-linear-to-br from-primary/10 via-background to-secondary/30 p-6 sm:p-10 shadow-lg\">\n    <div class=\"flex items-center gap-2 mb-4\">\n      <span class=\"inline-flex items-center gap-1.5 px-3.5 py-1 text-xs font-bold tracking-wide rounded-full bg-primary text-primary-foreground uppercase shadow-xs\">\n        🔍 মৌলিক তাত্ত্বিক ও সামাজিক গবেষণা\n      </span>\n      <span class=\"text-xs text-muted-foreground font-medium\">লেখক: আলম এম.</span>\n    </div>\n    <h1 class=\"text-2xl sm:text-4xl font-extrabold text-foreground tracking-tight mb-4\">\n      শিরক কী, মুশরিক কারা? শুধু মূর্তিপূজা নয় — বহুমাত্রিক বিশ্লেষণ\n    </h1>\n    <p class=\"text-base sm:text-lg leading-relaxed text-foreground font-medium mb-3\">\n      “শিরক” শব্দের সাধারণ অর্থ — আল্লাহর সাথে কাউকে অংশীদার করা। কিন্তু কুরআনের গভীর বিশ্লেষণে এটি কেবল কিছু পাথরের মূর্তিকে পূজা করার নাম নয়; এটি মানুষের চেতনা, নির্ভরতা, সমাজব্যবস্থা ও রাজনৈতিক কর্তৃত্বের এক সূক্ষ্ম ও মারাত্মক অবক্ষয়।\n    </p>\n    <div class=\"p-4 rounded-2xl bg-card border border-border space-y-2 mt-4\">\n      <span class=\"text-xs font-bold text-primary uppercase block\">কুরআন নিজেই মূলনীতি স্থাপন করে দেয় (৪:৮২):</span>\n      <p class=\"text-sm font-arabic text-foreground\">أَفَلَا يَتَدَبَّرُونَ الْقُرْآنَ ۚ وَلَوْ كَانَ مِنْ عِندِ غَيْرِ اللَّهِ لَوَجَدُوا فِيهِ اخْتِلَافًا كَثِيرًا</p>\n      <p class=\"text-xs text-muted-foreground\"><strong>Surface (প্রচলিত অনুবাদ):</strong> “তারা কি কুরআন নিয়ে গভীরভাবে চিন্তা করে না? যদি এটি আল্লাহ ছাড়া অন্য কারও কাছ থেকে হতো, তবে এতে বহু অসংগতি পেত।”</p>\n      <p class=\"text-sm font-semibold text-foreground\"><strong>Core Meaning:</strong> কুরআন একটি সামঞ্জস্যপূর্ণ, বিরোধহীন বাণী — এটি বুঝতে হলে চিন্তা করতে হবে।</p>\n      <p class=\"text-xs text-primary font-medium\"><strong>Underlying Meaning:</strong> অন্ধ অনুসরণ নয় — প্রশ্ন, বিশ্লেষণ এবং বুদ্ধিবৃত্তিক সততার মাধ্যমেই সত্যকে উপলব্ধি করতে হবে।</p>\n    </div>\n  </div>\n\n  <!-- ১. আল্লাহর নামে মনগড়া হালাল-হারাম নির্ধারণ -->\n  <div class=\"rounded-3xl border border-border bg-card p-6 sm:p-8 shadow-sm space-y-4\">\n    <div class=\"flex items-center gap-3 border-b border-border/60 pb-3\">\n      <span class=\"size-8 rounded-xl bg-primary/10 text-primary flex items-center justify-center font-bold text-lg\">১</span>\n      <h2 class=\"text-xl sm:text-2xl font-bold text-foreground\">আল্লাহর নামে মনগড়া হালাল-হারাম নির্ধারণ</h2>\n    </div>\n    <p class=\"text-sm font-arabic text-foreground\">قُل لَّا أَجِدُ فِي مَا أُوحِيَ إِلَيَّ مُحَرَّمًا عَلَىٰ طَاعِمٍ يَطْعَمُهُ... (সূরা আল-আন‘আম ৬:১৪৫)</p>\n    <div class=\"space-y-2 text-sm\">\n      <p class=\"text-muted-foreground\"><strong>Surface (প্রচলিত অনুবাদ):</strong> “বলুন, আমার কাছে যা ওহী হয়েছে তাতে আমি মৃত প্রাণী, প্রবাহিত রক্ত, শুকরের মাংস এবং আল্লাহ ছাড়া অন্যের নামে জবাইকৃত ছাড়া আর কিছু হারাম পাই না...”</p>\n      <p class=\"font-semibold text-foreground\"><strong>Core Meaning:</strong> হারাম-হালালের চূড়ান্ত সীমা নির্ধারণের সার্বভৌম অধিকার একমাত্র আল্লাহর।</p>\n      <p class=\"p-3 rounded-xl bg-destructive/10 border border-destructive/30 text-foreground font-medium\">\n        💡 <strong>Underlying Meaning:</strong> যে ব্যক্তি বা গোষ্ঠী আল্লাহর নামে নিজেরা বিধান তৈরি করে — সে আসলে আল্লাহর নিরঙ্কুশ কর্তৃত্বে অংশীদার বসাচ্ছে। এটিই ধর্মীয় অঙ্গনে শিরকের সবচেয়ে সূক্ষ্ম ও বিস্তৃত রূপ।\n      </p>\n    </div>\n  </div>\n\n  <!-- ২. শাফায়াত (মধ্যস্থতার বিশ্বাস) ও সামাজিক দুর্নীতি -->\n  <div class=\"rounded-3xl border border-border bg-card p-6 sm:p-8 shadow-sm space-y-6\">\n    <div class=\"flex items-center gap-3 border-b border-border/60 pb-3\">\n      <span class=\"size-8 rounded-xl bg-primary/10 text-primary flex items-center justify-center font-bold text-lg\">২</span>\n      <h2 class=\"text-xl sm:text-2xl font-bold text-foreground\">শাফায়াত (মধ্যস্থতার বিশ্বাস) ও নির্ভরতার বিচ্যুতি</h2>\n    </div>\n\n    <div class=\"grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm\">\n      <div class=\"p-4 rounded-2xl bg-muted/40 border border-border/80 space-y-2\">\n        <span class=\"text-xs font-bold text-primary\">সূরা আল-বাকারা (২:৪৮)</span>\n        <p class=\"text-xs text-muted-foreground\">“সেদিন কেউ কারো পক্ষ থেকে কিছুই কাজে আসবে না, কোনো সুপারিশ গ্রহণ করা হবে না...”</p>\n        <p class=\"font-semibold text-foreground\">Core Meaning: মানুষ নিজের কাজের জন্য নিজেই দায়ী — কেউ কাউকে উদ্ধার করতে পারবে না।</p>\n        <p class=\"text-xs text-primary\">Underlying: আল্লাহর সাথে সরাসরি সম্পর্ক বাদ দিয়ে “মধ্যস্থতাকারী” খোঁজা হলো আস্থার ঘাটতি ও দায় এড়ানোর বিভ্রান্তি।</p>\n      </div>\n\n      <div class=\"p-4 rounded-2xl bg-muted/40 border border-border/80 space-y-2\">\n        <span class=\"text-xs font-bold text-primary\">মক্কার মুশরিকদের যুক্তি (১০:১৮)</span>\n        <p class=\"text-xs text-muted-foreground\">“তারা বলে — এরা আল্লাহর কাছে আমাদের সুপারিশকারী।”</p>\n        <p class=\"font-semibold text-foreground\">Core Meaning: তারা আল্লাহকে বিশ্বাস করতো, কিন্তু মধ্যস্থতাকারী বানাতো।</p>\n        <p class=\"text-xs text-primary\">Underlying: সমস্যা বিশ্বাসে নয় — সমস্যা নির্ভরতার কাঠামোতে।</p>\n      </div>\n    </div>\n\n    <!-- সামাজিক দুর্নীতির বক্স -->\n    <div class=\"p-5 rounded-2xl bg-primary/10 border border-primary/30 space-y-3\">\n      <h3 class=\"text-base font-bold text-primary flex items-center gap-2\">\n        ⚠️ শাফায়াত ও বাস্তব সামাজিক দুর্নীতি\n      </h3>\n      <p class=\"text-sm leading-relaxed text-foreground/90\">\n        এই ভুল ধারণা শুধু ধর্মীয় ক্ষতি করে না — সমাজেও এর বিষাক্ত প্রভাব পড়ে। যে ব্যক্তি বিশ্বাস করে পরকালে “কেউ তাকে ব্যাকডোর দিয়ে বাঁচিয়ে দেবে” — সে বাস্তব জীবনেও “শর্টকাট ও ব্যাকডোর” খোঁজে:\n      </p>\n      <ul class=\"list-disc list-inside space-y-1 text-xs sm:text-sm text-foreground/80 pl-2\">\n        <li>যোগ্যতা ছাড়াই সুপারিশে চাকরি নেওয়া।</li>\n        <li>ক্ষমতাবান ও মধ্যস্বত্বভোগীদের মাধ্যমে অন্যায় সুবিধা নেওয়া।</li>\n        <li>নিজের দায়িত্ব ও জবাবদিহিতা এড়িয়ে অন্যকে সামনে আনা।</li>\n      </ul>\n      <p class=\"text-xs text-muted-foreground font-mono\">এই মানসিকতা — উভয় জগতেই একই পরজীবী শিকড় থেকে জন্ম নেয়।</p>\n    </div>\n  </div>\n\n  <!-- ৩. মসজিদ ও আহ্বান: কেবল আল্লাহর জন্য -->\n  <div class=\"rounded-3xl border border-border bg-card p-6 sm:p-8 shadow-sm space-y-4\">\n    <div class=\"flex items-center gap-3 border-b border-border/60 pb-3\">\n      <span class=\"size-8 rounded-xl bg-primary/10 text-primary flex items-center justify-center font-bold text-lg\">৩</span>\n      <h2 class=\"text-xl sm:text-2xl font-bold text-foreground\">মসজিদ ও আহ্বান: কেবল আল্লাহর জন্য (৭২:১৮)</h2>\n    </div>\n    <p class=\"text-sm font-arabic text-foreground\">وَأَنَّ الْمَسَاجِدَ لِلَّهِ فَلَا تَدْعُوا مَعَ اللَّهِ أَحَدًا</p>\n    <div class=\"space-y-2 text-sm\">\n      <p class=\"text-muted-foreground\"><strong>Surface:</strong> “নিশ্চয়ই মসজিদসমূহ আল্লাহর জন্য, সুতরাং আল্লাহর সাথে অন্য কাউকে ডেকো না।”</p>\n      <p class=\"font-semibold text-foreground\"><strong>Core Meaning:</strong> যে সব স্থানে বা অবস্থায় মানুষ নত হয় (আত্মসমর্পণ করে — স্থান: মানুষের অন্তর যা আসল মসজিদ), তা একমাত্র আল্লাহর জন্য নির্ধারিত — সুতরাং সেই আত্মসমর্পণে অন্য কাউকে অংশীদার করা যাবে না।</p>\n      <p class=\"p-3 rounded-xl bg-muted/60 border border-border text-foreground font-medium leading-relaxed\">\n        🔍 <strong>Underlying Meaning (রুট-ভিত্তিক দৃষ্টি):</strong> মানুষের চেতনা, সিদ্ধান্ত এবং আত্মসমর্পণের সমস্ত ক্ষেত্র এককভাবে আল্লাহ-নির্ভর হওয়া উচিত। যেখানে অর্থাৎ অন্তরে মানুষ “নত হয়” (সিজদা/আনুগত্য), সেখানে কোনো দ্বিতীয় কর্তৃত্বকে ডাকা বা যুক্ত করা — আত্মিক বিভাজন ও শিরক সৃষ্টি করে।\n      </p>\n    </div>\n  </div>\n\n  <!-- ৪. ফেরাউন: শিরকের রাজনৈতিক ও শাসনতান্ত্রিক রূপ -->\n  <div class=\"rounded-3xl border border-border bg-card p-6 sm:p-8 shadow-sm space-y-4\">\n    <div class=\"flex items-center gap-3 border-b border-border/60 pb-3\">\n      <span class=\"size-8 rounded-xl bg-destructive/10 text-destructive flex items-center justify-center font-bold text-lg\">৪</span>\n      <h2 class=\"text-xl sm:text-2xl font-bold text-foreground\">ফেরাউন: শিরকের রাজনৈতিক রূপ</h2>\n    </div>\n    <p class=\"text-sm font-arabic text-foreground\">فَقَالَ أَنَا رَبُّكُمُ الْأَعْلَىٰ (সূরা আন-নাযিয়াত ৭৯:২৪)</p>\n    <div class=\"space-y-2 text-sm\">\n      <p class=\"text-muted-foreground\"><strong>Surface:</strong> “সে বলেছিল — আমি তোমাদের সর্বোচ্চ প্রতিপালক।”</p>\n      <p class=\"font-semibold text-foreground\"><strong>Core Meaning:</strong> ফেরাউন নিজেকে মানুষের ওপর সর্বোচ্চ কর্তৃত্বশালী শাসক হিসেবে প্রতিষ্ঠা করেছিল।</p>\n      <p class=\"p-3 rounded-xl bg-destructive/5 border border-destructive/20 text-foreground font-medium\">\n        👑 <strong>Underlying Meaning:</strong> যেখানে মানুষ নিজের স্বাধীনতা হারায় এবং অন্য কোনো মানুষের স্বৈরাচারী নিয়ন্ত্রণে অন্ধভাবে চলে যায় — সেখানে শিরকের এক ভয়ংকর রূপ জন্ম নেয়।\n      </p>\n    </div>\n    <div class=\"grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs sm:text-sm pt-2\">\n      <div class=\"p-3 rounded-xl bg-card border border-border\">\n        <strong>“আব্দ” (ع ب د):</strong> দাস / সেবক ➔ মানুষ কেবল আল্লাহর ‘আব্দ’, কোনো মানুষের নয়।\n      </div>\n      <div class=\"p-3 rounded-xl bg-card border border-border\">\n        <strong>“রব” (ر ب ب):</strong> প্রতিপালক ও একমাত্র প্রভু ➔ সার্বভৌম কর্তৃত্ব কেবল আল্লাহর।\n      </div>\n    </div>\n  </div>\n\n  <!-- ৫. ইবাদতের প্রকৃত অর্থ, কাফির বনাম মুশরিক এবং সংখ্যাগরিষ্ঠতার বিভ্রান্তি -->\n  <div class=\"grid grid-cols-1 md:grid-cols-2 gap-6\">\n\n    <div class=\"p-6 rounded-3xl border border-border bg-card space-y-3\">\n      <h3 class=\"text-lg font-bold text-primary flex items-center gap-2\">\n        💎 ইবাদতের প্রকৃত সার্বজনীন অর্থ\n      </h3>\n      <p class=\"text-xs sm:text-sm text-foreground/85 leading-relaxed\">\n        আমরা ইবাদতকে সংকীর্ণ করে ফেলেছি কেবল কিছু আনুষ্ঠানিক রীতিতে। কিন্তু কুরআনের দৃষ্টিতে:\n      </p>\n      <ul class=\"list-disc list-inside space-y-1 text-xs text-muted-foreground pl-2\">\n        <li>অসুস্থ ও বিপন্নকে সাহায্য করা</li>\n        <li>জ্ঞান ও সত্য অনুসন্ধান করা</li>\n        <li>সমাজে অবিচারের বিরুদ্ধে ন্যায় প্রতিষ্ঠা</li>\n        <li>পরিবার ও দুর্বলদের ভালোবাসা</li>\n        <li>সৎ ও হালালভাবে উপার্জন করা</li>\n      </ul>\n      <p class=\"text-xs font-semibold text-foreground\">সবই ইবাদত — যদি তা আল্লাহকেন্দ্রিক ও সত্যের উদ্দেশ্যে হয়।</p>\n    </div>\n\n    <div class=\"p-6 rounded-3xl border border-border bg-card space-y-3\">\n      <h3 class=\"text-lg font-bold text-primary flex items-center gap-2\">\n        👥 কাফির বনাম মুশরিক: রুট পার্থক্য\n      </h3>\n      <div class=\"text-xs sm:text-sm space-y-2 text-foreground/90\">\n        <p><strong>কাফির (ك ف ر):</strong> আক্ষরিক অর্থ ঢেকে রাখা, সত্য গোপন করা ও অকৃতজ্ঞ হওয়া।</p>\n        <p><strong>মুশরিক (ش ر ك):</strong> আল্লাহর নিরঙ্কুশ কর্তৃত্বে অন্য কাউকে অংশীদার বা নির্ভরশীল ভাবা।</p>\n        <p class=\"text-xs text-muted-foreground\">সব মুশরিক সত্য ঢেকে কাফির হতে পারে, কিন্তু দুটি ভিন্ন মানসিক অবস্থা। যখন কেউ সত্য জেনেও অহংকারে বিরোধিতা করে, তখন তা সক্রিয় অবাধ্যতায় রূপ নেয়।</p>\n      </div>\n    </div>\n\n  </div>\n\n  <!-- ৬. সংখ্যাগরিষ্ঠতা সত্যের মানদণ্ড নয় (ইউসুফ ১২:১০৩, ১২:১০৬) -->\n  <div class=\"rounded-3xl border border-border bg-card p-6 sm:p-8 shadow-sm space-y-4\">\n    <h3 class=\"text-lg sm:text-xl font-bold text-foreground\">\n      📊 সংখ্যাগরিষ্ঠতা কখনো সত্যের মাপকাঠি নয়\n    </h3>\n    <div class=\"grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs sm:text-sm\">\n      <div class=\"p-4 rounded-2xl bg-muted/40 border border-border/80 space-y-2\">\n        <span class=\"font-bold text-primary\">সূরা ইউসুফ (১২:১০৩)</span>\n        <p class=\"text-muted-foreground\">“আপনি যতই আগ্রহী হোন, অধিকাংশ মানুষ ঈমান আনবে না।”</p>\n        <p class=\"font-semibold text-foreground\">Core: সত্য অনুসরণকারীর সংখ্যা সবসময় কমই হয়। সংখ্যা নয়, সত্য নিজেই নিজের প্রমাণ।</p>\n      </div>\n      <div class=\"p-4 rounded-2xl bg-muted/40 border border-border/80 space-y-2\">\n        <span class=\"font-bold text-primary\">সূরা ইউসুফ (১২:১০৬)</span>\n        <p class=\"text-muted-foreground\">“তাদের অধিকাংশ আল্লাহকে বিশ্বাস করে, কিন্তু সাথে শিরক করে।”</p>\n        <p class=\"font-semibold text-foreground\">Core: বিশ্বাসের সাথে শিরকের সূক্ষ্ম মিশ্রণ ঘটে থাকে। শিরক মূলত দৃষ্টিভঙ্গি ও নির্ভরতার ভেতরে লুকিয়ে থাকে।</p>\n      </div>\n    </div>\n    <div class=\"p-4 rounded-2xl bg-destructive/10 border border-destructive/20 text-xs sm:text-sm text-foreground\">\n      <strong>আত্মপ্রবঞ্চনার শেষ বাস্তবতা (সূরা ৬:২৩):</strong> <em>“তারা বলবে — আমরা তো মুশরিক ছিলাম না।”</em> মানুষ নিজের ভুল স্বীকার করতে চায় না। শিরক এমন এক সূক্ষ্ম আত্মপ্রবঞ্চনা যেখানে মানুষ নিজেই বুঝতে পারে না যে সে ভুলের মধ্যে নিমজ্জিত।\n    </div>\n  </div>\n\n  <!-- সমাপনী ভাবনা ও আহ্বান -->\n  <div class=\"rounded-3xl border-2 border-primary/30 bg-primary/5 p-6 sm:p-10 space-y-4\">\n    <h3 class=\"text-xl sm:text-2xl font-extrabold text-foreground\">\n      🏁 সমাপনী ভাবনা: কুরআনের আহ্বান\n    </h3>\n    <p class=\"text-sm sm:text-base leading-relaxed text-foreground/90\">\n      কুরআন কখনো বলে না অন্ধভাবে অনুসরণ করো। বরং বারবার আহ্বান করে:\n    </p>\n    <div class=\"grid grid-cols-2 sm:grid-cols-3 gap-2 text-xs font-semibold text-foreground\">\n      <span class=\"p-2.5 rounded-xl bg-card border border-border text-center\">🧠 চিন্তা করো</span>\n      <span class=\"p-2.5 rounded-xl bg-card border border-border text-center\">❓ প্রশ্ন করো</span>\n      <span class=\"p-2.5 rounded-xl bg-card border border-border text-center\">🔬 প্রমাণ খোঁজো</span>\n      <span class=\"p-2.5 rounded-xl bg-card border border-border text-center\">🛡️ বিবেক সমর্পণ করো না</span>\n      <span class=\"p-2.5 rounded-xl bg-card border border-border text-center\">🚫 বাহ্যিক রূপ বর্জন করো</span>\n      <span class=\"p-2.5 rounded-xl bg-card border border-border text-center\">📊 সংখ্যাগরিষ্ঠতা বর্জন করো</span>\n    </div>\n    <div class=\"p-4 rounded-2xl bg-card border border-primary/30 text-xs sm:text-sm text-foreground font-medium space-y-1\">\n      <p><strong>আল্লাহ চান:</strong> তুমি একজন স্বাধীন চিন্তাশীল মানুষ হও • ন্যায়ের পক্ষে দাঁড়াও • মানবিক হও • পরিবারের প্রতি সদয় হও • সৎ হও • ধৈর্য ধরো • এবং একমাত্র আল্লাহর ওপরই সম্পূর্ণ ভরসা রাখো।</p>\n    </div>\n    <div class=\"pt-2 border-t border-border/60 flex items-center justify-between text-xs font-mono text-muted-foreground\">\n      <span>© আলম (Alam M)</span>\n      <span>শিরক ও তাওহীদ গবেষণা সিরিজ · ৪:৮২ ফিল্টার</span>\n    </div>\n  </div>\n\n</div>\n  ",
  "content_en": "\n<div class=\"article-rich-container space-y-10 text-foreground/90 font-sans\">\n\n  <!-- Introduction Banner -->\n  <div class=\"rounded-3xl border-2 border-primary/20 bg-linear-to-br from-primary/10 via-background to-secondary/30 p-6 sm:p-10 shadow-lg\">\n    <div class=\"flex items-center gap-2 mb-4\">\n      <span class=\"inline-flex items-center gap-1.5 px-3.5 py-1 text-xs font-bold tracking-wide rounded-full bg-primary text-primary-foreground uppercase shadow-xs\">\n        🔍 Foundational Philosophical & Sociological Research\n      </span>\n      <span class=\"text-xs text-muted-foreground font-medium\">Author: Alam M</span>\n    </div>\n    <h1 class=\"text-2xl sm:text-4xl font-extrabold text-foreground tracking-tight mb-4\">\n      What is Shirk and Who are the Mushrikun? Beyond Idolatry: Multi-Dimensional Analysis\n    </h1>\n    <p class=\"text-base sm:text-lg leading-relaxed text-foreground font-medium mb-3\">\n      The conventional definition of \"Shirk\" is associating partners with God. However, through deep Quranic semantics, Shirk is not limited to physical idol worship; it represents a profound degradation of human consciousness, cognitive dependency, and socio-political sovereignty.\n    </p>\n    <div class=\"p-4 rounded-2xl bg-card border border-border space-y-2 mt-4\">\n      <span class=\"text-xs font-bold text-primary uppercase block\">The Quran Establishes the Benchmark (Surah 4:82):</span>\n      <p class=\"text-xs text-muted-foreground\"><strong>Surface:</strong> \"Do they not reflect upon the Quran? If it had been from other than Allah, they would have found within it much contradiction.\"</p>\n      <p class=\"text-sm font-semibold text-foreground\"><strong>Core Meaning:</strong> The Quran is an invariant, non-contradictory message — understanding it requires rigorous intellect.</p>\n      <p class=\"text-xs text-primary font-medium\"><strong>Underlying Meaning:</strong> Rejection of blind dogma; truth is apprehended through inquiry, analytical rigor, and intellectual integrity.</p>\n    </div>\n  </div>\n\n  <!-- 1. Fabricating Religious Boundaries -->\n  <div class=\"rounded-3xl border border-border bg-card p-6 sm:p-8 shadow-sm space-y-4\">\n    <div class=\"flex items-center gap-3 border-b border-border/60 pb-3\">\n      <span class=\"size-8 rounded-xl bg-primary/10 text-primary flex items-center justify-center font-bold text-lg\">1</span>\n      <h2 class=\"text-xl sm:text-2xl font-bold text-foreground\">Fabricating Halal and Haram in God's Name (6:145)</h2>\n    </div>\n    <div class=\"space-y-2 text-sm\">\n      <p class=\"font-semibold text-foreground\"><strong>Core Meaning:</strong> The sovereign right to determine sacred moral boundaries belongs exclusively to God.</p>\n      <p class=\"p-3 rounded-xl bg-destructive/10 border border-destructive/30 text-foreground font-medium\">\n        💡 <strong>Underlying Meaning:</strong> When individuals or clerics legislate religious restrictions in God's name, they usurp divine legislative authority — the most subtle form of religious polytheism.\n      </p>\n    </div>\n  </div>\n\n  <!-- 2. Intercession (Shafa'at) and Societal Corruption -->\n  <div class=\"rounded-3xl border border-border bg-card p-6 sm:p-8 shadow-sm space-y-4\">\n    <div class=\"flex items-center gap-3 border-b border-border/60 pb-3\">\n      <span class=\"size-8 rounded-xl bg-primary/10 text-primary flex items-center justify-center font-bold text-lg\">2</span>\n      <h2 class=\"text-xl sm:text-2xl font-bold text-foreground\">Intercession (Shafa'at) & Structural Corruption (2:48, 10:18)</h2>\n    </div>\n    <div class=\"grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm\">\n      <div class=\"p-4 rounded-2xl bg-muted/40 border border-border/80 space-y-2\">\n        <span class=\"text-xs font-bold text-primary\">Surah Al-Baqarah (2:48)</span>\n        <p class=\"font-semibold text-foreground\">Core Meaning: Every human node is directly accountable for their actions; no external intermediary can rescue them.</p>\n      </div>\n      <div class=\"p-4 rounded-2xl bg-muted/40 border border-border/80 space-y-2\">\n        <span class=\"text-xs font-bold text-primary\">The Meccan Argument (10:18)</span>\n        <p class=\"font-semibold text-foreground\">Core Meaning: They acknowledged God, but sought intermediaries — the error lies in the architecture of dependency.</p>\n      </div>\n    </div>\n    <div class=\"p-4 rounded-2xl bg-primary/10 border border-primary/30 text-xs sm:text-sm text-foreground\">\n      <strong>Societal Corruption:</strong> Believing in spiritual intermediaries fosters real-world nepotism, backdoor recommendations, and evasion of personal responsibility.\n    </div>\n  </div>\n\n  <!-- 3. Pharaoh & Political Shirk -->\n  <div class=\"rounded-3xl border border-border bg-card p-6 sm:p-8 shadow-sm space-y-4\">\n    <div class=\"flex items-center gap-3 border-b border-border/60 pb-3\">\n      <span class=\"size-8 rounded-xl bg-destructive/10 text-destructive flex items-center justify-center font-bold text-lg\">3</span>\n      <h2 class=\"text-xl sm:text-2xl font-bold text-foreground\">Pharaoh: The Political Architecture of Shirk (79:24)</h2>\n    </div>\n    <div class=\"space-y-2 text-sm\">\n      <p class=\"font-semibold text-foreground\"><strong>Core Meaning:</strong> Pharaoh established himself as the absolute totalitarian sovereign over human beings.</p>\n      <p class=\"p-3 rounded-xl bg-destructive/5 border border-destructive/20 text-foreground font-medium\">\n        👑 <strong>Underlying Meaning:</strong> When individuals surrender their freedom and conscience to authoritarian human control, an acute manifestation of Shirk occurs. Humans are 'Abd' (servants) exclusively to Allah.\n      </p>\n    </div>\n  </div>\n\n  <!-- Conclusion -->\n  <div class=\"rounded-3xl border-2 border-primary/30 bg-primary/5 p-6 sm:p-10 space-y-4\">\n    <h3 class=\"text-xl sm:text-2xl font-extrabold text-foreground\">\n      🏁 Conclusion: The Quranic Manifesto of Freedom\n    </h3>\n    <p class=\"text-sm sm:text-base leading-relaxed text-foreground/90\">\n      The Quran never demands blind submission. It calls humanity to think, question, verify empirical evidence, protect cognitive independence, reject majoritarian illusions, and place absolute trust solely in Allah.\n    </p>\n    <div class=\"pt-2 border-t border-border/60 flex items-center justify-between text-xs font-mono text-muted-foreground\">\n      <span>© Alam M (আলম)</span>\n      <span>Shirk & Tawhid Analysis · 4:82 Framework</span>\n    </div>\n  </div>\n\n</div>\n  "
},
{
