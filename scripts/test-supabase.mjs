...
const widgetCode = `// src/components/GoogleTranslateWidget.tsx
...
fs.writeFileSync("src/components/GoogleTranslateWidget.tsx", widgetCode);
console.log("Successfully created GoogleTranslateWidget.tsx!");
process.exit(0);
const dummy = `
