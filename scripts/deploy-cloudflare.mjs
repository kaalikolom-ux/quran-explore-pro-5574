...
function deployTo(workerName, label) {
...
if (target === "wooniche" || target === "main") {
  deployTo("kaalikolom-ux-quran-explore-pro-5574", "wooniche.com (Main Site)");
} else if (target === "sub" || target === "alam-m") {
  deployTo("alam-m", "a.wooniche.com (Subdomain)");
} else {
  deployTo("kaalikolom-ux-quran-explore-pro-5574", "wooniche.com (Main Site)");
  deployTo("alam-m", "a.wooniche.com (Subdomain)");
}
